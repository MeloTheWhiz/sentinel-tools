...
class LinuxPlatform(PlatformBackend):
    """Collect diagnostics from Linux systems."""
    ...
    def collect_system(self) -> dict[str, str]:
        """Collect Linux identity, service, package, and journal information."""
        ...
        data["High-priority errors from this boot"] = filter_journal_output(
            journal_output
        )
